...
class SessionController extends ChangeNotifier {
  ...
  Future<void> applyProfile(DefenderDemoProfile profile) async {
    ...
    await FlutterDefender.instance.init(
      ...
      enableProxyVpnDetection: config.enableProxyVpnDetection,
      enableRaspDetection: config.enableRaspDetection,
      enableSecureStorageHelper: config.enableSecureStorageHelper,
      clearSecureStorageOnLogout: config.clearSecureStorageOnLogout,
      blockingScreenBuilder: config.blockingScreenBuilder,
      onLogoutRequested: logoutHandler,
      onRootDetected: () => _addEvent('Root/Jailbreak detection triggered'),
      onProxyOrVpnDetected: () => _addEvent('Proxy/VPN detection triggered'),
      onTamperingDetected: () =>
          _addEvent('RASP tampering detection triggered'),
